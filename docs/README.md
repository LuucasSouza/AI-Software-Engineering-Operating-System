...
document_type: "Directory Overview"
---
...
Centralizar documentação conceitual, institucional e de referência do AI-SEOS.

## Escopo

Inclui visão, filosofia, governança, glossário, arquitetura e documentação de apoio.
...
- Linguagem orientada a decisão e uso.

## Responsabilidades

Documentation Maintainers mantêm consistência, clareza, versionamento e relação com os documentos raiz.
...
## Documentação adicionada na Phase 5

- `packages/resolve-ai-cli/README.md`: documentação atualizada com `resolve-ai diagnosticar`.
...
## Documentação adicionada na Phase 7

- `packages/resolve-ai-cli/README.md`: documentação atualizada com `resolve-ai preparar`.
- `sprints/phase-7-handoff.md`: handoff da Phase 7.
- `sprints/phase-7-validation-report.md`: validação da Phase 7.
- `sprints/phase-7-retrospective.md`: retrospectiva da Phase 7.

## Documentação adicionada na Phase 8

- `packages/resolve-ai-cli/README.md`: documentação atualizada com `resolve-ai resolver`.
- `sprints/phase-8-handoff.md`: handoff da Phase 8.
- `sprints/phase-8-validation-report.md`: validação da Phase 8.
- `sprints/phase-8-retrospective.md`: retrospectiva da Phase 8.

## Documentação adicionada na Phase 9

- `packages/resolve-ai-cli/README.md`: documentação atualizada com `resolve-ai validar`.
...
## Documentação adicionada na Phase 14

- `alpha-validation/real-users/phase-14-real-user-validation-plan.md`: plano de validação real.
- `alpha-validation/real-users/phase-14-real-user-validation-matrix.md`: matriz por perfil.
- `alpha-validation/real-users/phase-14-*-session.md`: relatórios pendentes por perfil.
- `alpha-validation/real-users/phase-14-consolidated-findings.md`: achados consolidados.
- `alpha-validation/real-users/profile-score-summary.md`: resumo de scores por perfil.
- `community/real-alpha-feedback-backlog.md`: backlog de feedback real.
- `community/real-alpha-feedback-triage.md`: triagem de feedback real.
- `release/v0.1.0-alpha-phase-14-*.md`: scorecard, decisão, blockers e package review.
...
## Documentação adicionada na Phase 15B

- `alpha-validation/private-alpha/phase-15b/`: plano, tracker, runbook, relatórios, evidence register, consolidação e scorecard.
- `community/private-alpha-phase-15b-feedback-triage.md`: triagem de feedback.
- `community/private-alpha-phase-15b-fix-backlog.md`: backlog de fixes.
- `community/private-alpha-phase-15b-fixes-applied.md`: fixes aplicados.
- `release/v0.1.0-alpha-phase-15b-*.md`: scorecard, decisão, blockers, package review e recomendação.
- `sprints/phase-15b-handoff.md`: handoff da Phase 15B.
- `sprints/phase-15b-validation-report.md`: validação da Phase 15B.
- `sprints/phase-15b-retrospective.md`: retrospectiva da Phase 15B.
