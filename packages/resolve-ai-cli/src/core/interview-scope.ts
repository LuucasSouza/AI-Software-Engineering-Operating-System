import type { ProjectScope, ResolveAiState } from "../types/runtime.js";
...
export function isNegatedStatement(text: string): boolean {
...
export function mentionsSensitiveData(text: string): boolean {
...
function splitListAnswer(text: string): string[] {
...
export function extractProjectScopeFromInterview(state: ResolveAiState | null): ProjectScope | null {
