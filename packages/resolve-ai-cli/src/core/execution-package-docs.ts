...
import type { PreparedTask } from "../types/runtime.js";
...
export function writeExecutionPackageDocs(root: string, task: PreparedTask): { created: string[]; preserved: string[] } {
